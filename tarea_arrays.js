...
let sumResistance = 0 
 ...
 const sumResistencia = resistanceValues => {
        let sum = 0;

    resistanceValues.forEach(resis)
...
//1er paso: Inicialización let index =0 
//2do paso: realiza la comparacion index <array.length
//3er paso ejecuta el contenido
//4paso : incremento o decremento index++
